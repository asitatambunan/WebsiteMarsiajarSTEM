			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Cara Pembuatan Bunga Matahari Dari Sedotan</div>
						
						<div class="blog_image"><img src="images/bunga.webp" alt=""></div>
						<div class="blog_post_text">
							<h2 class="justify">Bahan-bahan</h2>
						<ol><p>
							<li><p>T4 buah sedotan warna kuning</p></li>
							<li><p>Kertas lipat warna coklat</p></li>
							<li><p>Lem</p></li>                   
                            <li><p>Jarum</p></li>
                            <li><p>Gunting</p></li>
                            <li><p>Benang</p></li>
						...
						<ol><p>
							<li><p>Potong sedotan menjadi masing-masing 4 bagian yang sama panjang. Setelah semua sedotan terpotong, sejajarkan bagian-bagian sedotan. Masukkan benang pada lubang jarum dan rangkai sedotan dengan benang dan jarum.</p></li>
							<li><p>Kencangkan dan tarik sehingga sedotan membentuk lingkaran menyerupai bunga.</p></li>
							<li><p>Kemudian, buat simpul mati sehingga bentuk bunga tidak berubah lagi.</p></li>
							<li><p>Ambil gunting dan gunting ujung sedotan secara diagonal.</p></li>
                            <li><p>Ulangi semua langkah tadi hingga seluruh potongan sedotan habis dan ada 4 lingkaran bunga.</p></li>
                            <li><p>Tumpuk keempat lingkaran bunga tadi dan rekatkan dengan lem.</p></li>
                            <li><p>Potong lingkaran kecil dari kertas coklat dan tempelkan di bagian tengah bunga.</p></li>
                        </ol> </p>
						</div>
					</div>
				</div>
