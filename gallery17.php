			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Cara Pembuatan Burung Hantu dari Kardus</div>
						
						<div class="blog_image"><img src="images/burung_hantu.jpg" alt=""></div>
						...
						<ol><p>
							<li><p>Pertama tama kita gunting kardus bekas dengan lebar + 5cm dengan panjang menyesuaikan kardusnya</p></li>
							<li><p>Kemudian kita gulung potongan kardus tersebut hingga membentuk sebuah gulungan dengan diameter sekitar 7 cm. Kita buat dua buah gulungan yang fungsinya nanti ini sebagai bola mata</p></li>
							<li><p>Selanjutnya kita buat gulungan lagi dari potongan kardus tadi, sekarang dengan diameter +  12 – 15 cm yang berfungsi sebagai badan dari burung hantu nanti</p></li>
							<li><p>Setelah itu kita satukan ketiga gulungan tersebut dengan menggunakan lem</p></li>
                            <li><p>Tambahkan asesoris seperti mata, alis, paruh, bulu sayap, bulu ekor, dan pijakan</p></li>
						</ol> </p>
						</div>
							</div>
						</div>
