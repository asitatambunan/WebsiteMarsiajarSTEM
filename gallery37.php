			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Cara Pembuatan Pengharum Ruangan Dari Downy</div>
						
						<div class="blog_image"><img src="images/pewangi.jpg" alt=""></div>
						<div class="blog_post_text">
							<h2 class="justify">Bahan-bahan</h2>
						<ol><p>
							<li><p>pengharum pakaian downy</p></li>
							<li><p>air mineral</p></li>
							<li><p>cuka dapur</p></li>                   
                            <li><p>tisu</p></li>
                            <li><p>kantong plastik kecil</p></li>

						</ol></p>

						<h2 class="justify">Cara Pembuatan</h2>
						<ol><p>
							<li><p>siapkan wadah yang akan digunakan untuk menaruk campuran downy. Agar lebih mudah, carilah wadah spray yang kosong ataupun bekas. Jika Anda menggunakan botol bekas, cuci terlebih dahulu dan keringkan sebelum akan digunakan.</p></li>
							<li><p>Tahap berikutnya adalah membuat campuran downy. Masukan dalam wadah yang sudah di siapkan, cairan downy, air secukupnya serta cuka sebanyak lima tetes. Tutup wadah tersebut dan kocok hingga semuanya tercampur secara merata. Cuka penting untuk ditambahkan sebagai anti bakteri dan juga membuat aroma downy lebih tahan lama.</p></li>
                            <li><p>Selanjutnya, spray downy sudah dapat digunakan pada area-area rumah yang memiliki bau tidak sedap.</p></li>
                        </ol> </p>
						</div>
					</div>
				</div>
