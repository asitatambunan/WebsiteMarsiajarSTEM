			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Cara Pembuatan Lampu Hias dari Botol</div>
						
						<div class="blog_image"><img src="images/lampu_nenas.jpg" alt=""></div>
						<div class="blog_post_text">
							<h2 class="justify">Bahan-bahan</h2>
						<ol><p>
							<li><p>Botol bekas</p></li>
							<li><p>Sendok plastik</p></li>
							<li><p>Lampu lengkap</p></li>
                            <li><p>Pisau</p></li>
                            <li><p>Obeng</p></li>
                            <li><p>Lem</p></li>
                            <li><p>Cat</p></li>
                            <li><p>Tiang untuk tempat berdirinya lampu</h5></li>
						</ol></p>

						<h2 class="justify">Cara Pembuatan</h2>
						<ol><p>
							<li><p>Sediakan bahan serta perlengkapan yang diperlukan</p></li>
							<li><p>Langkah Berikutnya, potong botol plastik</p></li>
							<li><p>Potong-potong sendok plastik </p></li>
							<li><p>Satukan botol dengan sendok supaya tampak indah menggunakan lem</p></li>
                            <li><p>Cat sendok yang sudah ditempelkan</p></li>
                            <li><p>Potong-potong botol membentuk seperti daun nanas,lantas di cat</p></li>
                            <li><p>Pasang lampunya dan tiang untuk berdiri</p></li>
                            <li><p>Dan, lampu hias dari botol bekas pun siap untuk dipakai</p></li>
						</ol> </p>
						</div>
							</div>
						</div>
