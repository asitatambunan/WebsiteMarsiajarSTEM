			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Cara Pembuatan Sendok dari Batok Kelapa</div>
						
						<div class="blog_image"><img src="images/sendok.webp" alt=""></div>
						<div class="blog_post_text">
							<h2 class="justify">Bahan-bahan</h2>
						<ol><p>
							<li><p>Batok kelapa</p></li>
							<li><p>Kayu bambu kecil</p></li>
							<li><p>Kater</p></li>
                            <li><p>Gunting</p></li>
                            <li><p>Amplas</p></li>
						</ol></h5>
						...
						<ol><p>
							<li><p>Ambil batok kelapa yang sudah sahabat bersihkan dari daging buah sebelumnya. Kita amplas tempurung batok kelapa agar halus permukaannya</p></li>
							<li><p>Setelah itu gunakan gunting untuk melubangi batok kelapa kita. Lubang sesuaikan dengan kayu yang dipakai untuk ganggang nya</p></li>
							<li><p>Ambil kayu yang dipakai untuk ganggang. Raut kayu sehingga sesuai lubang yang kita buat pada batok kelapa </p></li>
							<li><p>Masukkan kedalam lubang dan sesuaikan hingga kuat</p></li>
						</ol> </p>
						</div>
							</div>
						</div>
