			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Cara Pembuatan Dispenser Kardus</div>
						
						<div class="blog_image"><img src="images/dispenser.jpg" alt=""></div>
						<div class="blog_post_text">
							<h2 class="justify">Bahan-bahan</h2>
						<ol><p>
							<li><p>Kardus bekas</p></li>
							<li><p>Suntikan</p></li>
							<li><p>Lem bakar</p></li>
							<li><p>Timah</p></li>
							<li><p>Solasi</p></li>
                            <li><p>Aerator Akuarium</p></li>
                            <li><p>Saklar listrik</p></li>
                            <li><p>Soft drink dan botolnya (Sprite, Coca-cola, Teh Botol, atau minuman lain)</p></li>
                            <li><p>Selang plastik</p></li>
                            <li><p>Pisau cutter</p></li>
                            <li><p>Gunting</p></li>
                            <li><p>Glue Gun</p></li>
                            <li><p>Solder</p></li>
                            <li><p>Penggaris</p></li>
                            <li><p>Pensil/ballpoint</p></li>
                            <li><p>Tang</p></li>
						</ol></p>
						<h2 class="justify">Cara Pembuatan</h2>
						<ol><p>
							<li><p>Buat gambar sketsa pada kardus bekas sesuai ukuran botol softdrink yang akan dipakai dan aerator akuarium karena akan disimpan di dalam. </p></li>
							<li><p>Potong kardus tersebut sesuai sketsa gambar yang tadi telah dibuat.</p></li>
							<li><p>Satukan (sambungkan) setiap potong kardus sampai membentuk dispenser mini menggunakan lem bakar. Lakukan dengan cepat karena lem bakar mudah kering. Jangan lupa lubangi bagian belakang untuk lubang kabel listrik. Jika Anda menggunakan aerator DC, maka kabel listrik tidak dibuthkan tetapi gantinya dengan battery yang bisa disimpan di dalam kotak.</p></li>
							<li><p>Pasang saklar listrik untuk menyalakan dan mematikan aerator dengan menghubungkan setiap titik terminal yang sesuai (jangan terbalik) dan kuatkan dengan meyoldernya dan tutup dengan solasi untuk keamanan.</p></li>
							<li><p>Lubangi tutup botol softdrink dengan solder panas sebanyak dua lubang.</p></li>
                            <li><p>Masukan selang plastik ke dalam tutup botol yang telah dilubangi kemudian tutup (rekatkan) dengan lem bakar. Jangan sampai bocor !! Satu selang sampai dasar cairan, satu lagi mengambang di udara.</p></li>
                            <li><p>Sambungkan bagian selang yang mengambang ke output aerator akuarium. Satunya lagi ke luar dispenser.</p></li>
                            <li><p>Tutup bagian-bagian yang terbuka dengan lem bakar.</p></li>
                            <li><p>Selesai.</p></li>
						</ol> </p>
						</div>
							</div>
