			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Cara Pembuatan Rangkaian Listrik Seri</div>
						
						<div class="blog_image"><img src="images/rangkaian_listrik.jpg" alt=""></div>
						<div class="blog_post_text">
							<h2 class="justify">Bahan-bahan</h2>
						<ol><p>
							<li><p>Kabel listrik</p></li>
							<li><p>Tiga buah bohlan dengan ukuran watt yang sama</p></li>
							<li><p>Duah buah baterai dengan voltase yang sama</p></li>
							<li><p>Skalar listrik</p></li>
							<li><p>Gunting</p></li>
						</ol></p>
						<h2 class="justify">Cara Pembuatan</h2>
						<ol><p>
							<li><p>Hubungkan ujung positif baterai 2 dengan ujung negatif baterai 1 dengan kabel listrik (menempelkan kawat tembaga dalam kabel ke ujung ujung baterai)</p></li>
							<li><p>Hubungkan ujung positif baterai 1 dengan saklar (relay) listrik dengan kabel.</p></li>
							<li><p>Hubungkan ujung negatif saklar ke ujung positif lampu dengan kabel.</p></li>
							<li><p>Hubungkan ujung negatif lampu 1 dengan ujung positif lampu 2, lalu dilanjutkan ujung negatif lampu 2 ke ujung positif lampu 3.</p></li>
							<li><p>Hubungkan ujung negatif lampu 3 dengan ujung negatif baterai 2.</p></li>
						</ol> </p>
						</div>
							</div>
						</div>
