			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Cara Pembuatan Tas dari Plastik bekas</div>
						
						<div class="blog_image"><img src="images/tas.webp" alt=""></div>
						<div class="blog_post_text">
							<h2 class="justify">Bahan-bahan</h2>
						<ol><p>
							<li><p>Kantong plastik</p></li>
							<li><p></p>Tali</li>
							<li><p>Kertas roti </p></li>                   
                            <li><p>Seal press</p></li>
                            <li><p>Gunting</p></li>
						...
						<ol><p>
							<li><p>Potong kresek bagian paling atas dan bawah. Pastikan potongan rapi hingga plastik berbentuk persegi.</p></li>
							<li><p>Letakkan plastik yang sudah dipotong keatas meja dan tutup menggunakan kertas roti kemudian setrika perlahan-lahan dan tidak terlalu lama ,setrika sampai berubah jadi lebih padat dan memiliki motif.</p></li>
							<li><p>Rapatkan bagian bawah plastik menggunakan seal press.Jika tidak mempunyai jahit plastik,sisakan sedikit ruang untuk memasukkan tali kedalamnya.</p></li>
							<li><p>Setelah semua terpasang,maka tas siap digunakan.</p></li>
                        </ol> </p>
						</div>
					</div>
				</div>
