			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Cara Pembuatan Kipas Angin Tanpa Baterai Dan Listrik</div>
						
						<div class="blog_image"><img src="images/kipas angin.png" alt=""></div>
						<div class="blog_post_text">
							<h2 class="justify">Bahan-bahan</h2>
						<ol><p>
							<li><p>Botol air mineral bekas</p></li>
							<li><p>Dua tutup botol mineral</p></li>
							<li><p>Kaleng minuman bersoda</p></li>
							<li><p>Lem tembak</p></li>
							<li><p>Kawat</p></li>
                            <li><p>Lima karet gelang</p></li>
						</ol></p>
						<h2 class="justify">Cara Pembuatan</h2>
						<ol><p>
							<li><p>Buatlah pola lingkaran d ibagian bawah kaleng minuman bersoda bekas menggunakan spidol, lalu lubangi menggunakan cutter.</p></li>
							<li><p>Lubangi tutup botol air mineral bada bagian luar, ratakan lubang menggunakan gunting.</p></li>
							<li><p>Tekuk kawat menjadi 2 bagian, kemudian masukkan karet di antara tekukan. Tarik karet agar tidak mudah putus.</p></li>
							<li><p>Masukkan kawat tersebut ke dalam tutup botol yang sudah dilubangi, sampai setengah bagian karet masuk.</p></li>
						</ol> </p>
						</div>
							</div>
						</div>
