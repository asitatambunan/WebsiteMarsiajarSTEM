			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Cara Pembuatan Tempat Tissue Dari Kardus</div>
						
						<div class="blog_image"><img src="images/tissue.jpg" alt=""></div>
						<div class="blog_post_text">
							<h2 class="justify">Bahan-bahan</h2>
						<ol><p>
							<li><p>Kardus bekas</p></li>
							<li><p>Kertas kado</p></li>
							<li><p>Lem</p></li>
                            <li><p>Gunting</p></li>
                            <li><p>Pita hias</p></li>
                            <li><p>Pensil dan penggaris</p></li>
                            <li><p>Tisu yang berbentuk persegi</p></li>
						</ol></p>

						<h2 class="justify">Cara Pembuatan</h2>
						<ol><p>
							<li><p>Buatlah pola terlebih dahulu di kardus mengguanakan pensil dan penggaris, sesuai panjang dan lebarnya tempat tisu</p></li>
							<li><p>Kemudian gunting kardus sesuai pola</p></li>
							<li><p>Lalu lem lah pola yang sudah digunting</p></li>
							<li><p>Satukan semua pola sesuai bentuk tisu menggunakan lem</p></li>
                            <li><p>Lem lah pita hias</p></li>
                            <li><p>Kemudian masukkanlah tisu tersebut</p></li>
                        </ol> </p>
						</div>
							</div>
						</div>
