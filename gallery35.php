			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_content">
						<div class="blog_title">Cara Pembuatan Guci Dari Batok Kelapa</div>
						
						<div class="blog_image"><img src="images/guci.webp" alt=""></div>
						<div class="blog_post_text">
							<h2 class="justify">Bahan-bahan</h2>
						<ol><p>
							<li><p>gergaji kecil</p></li>
							<li><p>amplas kasar</p></li>
							<li><p>amplas halus</p></li>                   
                            <li><p>pernis</p></li>
                            <li><p>lem</p></li>
                            <li><p>lem alteco</p></li>
                            <li><p>hiasan</p></li>
                            <li><p>tempurung kelapa</p></li>

						</ol></p>

						<h2 class="justify">Cara Pembuatan</h2>
						<ol><p>
							<li><p>bersihkan rambut yang ada di tempurung kelapa, setelah bersih diamplas dengan amplas kasar, setelah agak halus diamplas dengan amplas halus, buat pola mengitari batok kelapa kira kira 1/4 dari ujung bawah, yang atas juga dibuat pola kira-kira 1/4 mengitari batok kelapa diukur dari ujung atas</p></li>
							<li><p>ulangi langkah yang tadi pada beberapa batok kelapa yang lain, lem semua batok kelapa secara berurutan(batok kelapa yang pertama  diberi batok kelapa yang kedua di atasnya), ambil sisa pemotongan ujung batok kelapa dan di lem di bawah hasil tempelan tadi, tunggu kering lemnya, di pernis, tunggu hingga kering, siap dipakai</p></li>
                        </ol> </p>
						</div>
					</div>
				</div>
